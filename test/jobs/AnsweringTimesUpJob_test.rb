...
class AnsweringTimesUpJobTest < ActiveSupport::TestCase
  def setup
    ...
    @editor = Editor.create!(username: "at#{suffix}", email: "at#{suffix}@test.com", password: "password123", password_confirmation: "password123")
    @prompt = Prompt.create!(description: "ATU prompt #{suffix}", tags: "noun", creator: @editor)
